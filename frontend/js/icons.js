...
const ICONS = {
    ...
    xmessage: `<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M10 2.2l1.4 3.2 3.2 1.4-3.2 1.4-1.4 3.2-1.4-3.2-3.2-1.4 3.2-1.4L10 2.2z"/><path d="M10 5.1v9.8M5.1 10h9.8M6.5 6.5l6.9 6.9M13.5 6.5L6.6 13.4"/><circle cx="10" cy="10" r="1.2" fill="currentColor" stroke="none"/></svg>`,
