        ...
        content.innerHTML = `
            <div class="account-banner glass ${hasImage ? "has-image" : ""}" id="account-banner">
                ...
                <div class="banner-content">
                    <div class="banner-heading"><div><div class="banner-brand">${data.branding.webName || "SHOYU PANEL"}</div><div class="banner-subtitle">${data.branding.webSubtitle || "WhatsApp Management Panel"}</div></div></div>
