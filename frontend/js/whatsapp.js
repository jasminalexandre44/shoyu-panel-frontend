(async function () {
    ...
    async function startPairing() {
        ...
        try {
            ...
            resultBox.innerHTML = res.pairingCode
                ? `<div class="pill pairing" style="font-size:16px;padding:8px 14px">Kode: <strong>${res.pairingCode}</strong></div>
    ...
    content.innerHTML = `
        <div class="page-intro"><div><span class="page-kicker">Sender operations</span><h2>WhatsApp Management</h2><p>Pair, monitor, and remove WhatsApp sender sessions.</p></div><a class="btn secondary" href="/xmessage.html">Open XMessage</a></div>
