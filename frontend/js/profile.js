            ...
            <div class="profile-stack">
                <div class="card profile-summary-card">
                    ...
                    <div class="profile-summary-grid">
                        <div class="mini-stat"><span>Role</span><strong>${user.role}</strong></div>
                        <div class="mini-stat"><span>Status</span><strong>${statusText}</strong></div>
                        <div class="mini-stat"><span>Expiry</span><strong>${expiryText}</strong></div>
                    </div>
                </div>
